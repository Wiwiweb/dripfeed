...
class RSSGenerator {
    ...
    createFeed() {
        let requestedPageNb = this._getPageNbFromDateAndFrequency();
    ...
    _getPageNbFromDateAndFrequency() {
        ...
        return Math.ceil(timeIntervalInSecs / this.frequencyInSecs); // We round up because page numbers start at 1
    }
